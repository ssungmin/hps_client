...
def main(end_t, begin_t) :
   ...
   region_hps_df = sedona.sql("select collect_dt, collecttime, android_id, msmodel,in_out_none, collecttype, provider, gt_point,\
                               gt_latitude, gt_longitude, gt_accuracy, gt_dop, gt_hepe, gt_numsat, area_id,  airpress, wificonnssid,wificonnapmac ,wifiinfocnt , wifiinfo \
                               from out_all, region \
                              where collecttype in (1,2,3,4,5,50) \
   ...
   query = '''
      select collect_dt, collecttime,android_id, msmodel, in_out_none, collecttype, provider ,gt_point,  
             gt_latitude,  gt_longitude , gt_accuracy, gt_dop, gt_hepe, gt_numsat,  b.region as area_id ,   airpress, wificonnssid,wificonnapmac,
